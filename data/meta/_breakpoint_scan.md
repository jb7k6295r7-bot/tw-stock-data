...
母體 2130 檔，斷點 14 個、12 檔
rule
gap          9
price+gap    3
price        2
missing_trading_days 分布： {'min': 0.0, '50%': 55.5, 'max': 218.0}

對帳 par_change.csv：24 筆／22 檔 → 已有因子 24、仍為斷點 0、漏抓 0
規則另外抓到（不在 par_change.csv）：14 個、12 檔；其中 price 規則 5 個
stock_id market       date  prev_date     ratio  missing_trading_days      rule
    ...
    2330   twse 2026-09-08 2026-09-07    0.0008                     0     price
    2330   twse 2026-09-09 2026-09-08 1232.5000                     0     price
