...
def main():
    ...
    for name, sub, tier, why in (
            ...
            ("三大法人 inst", "inst", "C", "只有自我一致"),
            ("融資融券 margin", "margin", "C", "只有自我一致"),
            ("本益比 per", "per", "C", "只有自我一致"),
    ...
    L.append("| 三大法人 inst | 沒有第二個來源可以對 | 找另一個公布同一數字的地方 |")
    L.append("| 融資融券 margin | 同上 | 同上 |")
    L.append("| 本益比 per | 同上；⚠ 而且 2015 年那版**連收盤價欄都沒有** | 同上 |")
