...
#  M1 debounce 改成「短段丟掉不併入」⇒ 合成第 2、4 條紅（200 vs 203；50 vs 60）；⚠ 雜訊單調性仍綠——因為之後還有「合併相鄰同狀態」，
#     內部單日雜訊丟掉後前後同狀態會接回去，n 不變；真正會讓 n 往上走的是 1835 那種「不併也不合併、各段分開數」的定義（實測 2026-09-14）
