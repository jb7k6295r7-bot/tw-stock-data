...
⛔ 登錄全文 `backtest/PREREGP15.md`（策略線 seq=4）
   ⚠ 投遞時間：Drive createdTime ＝ **2026-09-22 02:16 台北**（⭐ 機器時鐘，跨線對時序一律用它）
   ⛔ 而標題與 pw1 行都標「2026-09-22 14:10」⇒ 標籤漂移 +11.9 h（策略線 1015 §四 自報同一族）
